...
# Output control
# -------------------------------------------------
out_fname = "output_exc3.3_shear_c"  # file name of output
...
# Topography
# -------------------------------------------------
topomx = 1400 #500  # mountain height [m]
topowd = 25000 #50000  # mountain half width [m]
topotim = 1800  # mountain growth time [s]

# Initial atmosphere
# -------------------------------------------------
u00 = 10 #22.5  # initial velocity [m/s]
...
k_sht = 34  # top level of wind shear layer (ishear = 1)
