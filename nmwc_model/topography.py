...
def double_trapez_topo(x, width_1, width_2, width_3, width_4, height_1, height_2):
    ...
    For width_1 = 0 and width_2 = width_3, this creates two triangles.
    For width_2 = width_1 + 1e-13 and width_4 = width_3 + 1e-13, this creates two rectangles.
...
def fetch_topo(x, topowd, topomx, topotype):
    ...
    if topotype=="gauss":
        ...
        print("Error: Unknown Topography Type")
        quit()